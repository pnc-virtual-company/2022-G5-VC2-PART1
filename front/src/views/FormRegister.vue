                ...
                <div class="row">
                    <div class="col-md-6 mb-4">
                        <div class="form-outline">
                            <input type="text" id="firstName" class="form-control form-control-lg" placeholder="First Name" required v-model="firstName"/>
                        </div>
                    </div>
                    <div class="col-md-6 mb-4">
                        <div class="form-outline">
                            <input type="text" id="lastName" class="form-control form-control-lg" placeholder="Last Name" required v-model="lastName"/>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6 mb-4 d-flex align-items-center">
                        <select class="form-select form-select-lg" required v-model="batch">
                            <option :value="batch" v-for="batch in batchCategories" :key="batch">{{batch}}</option>
                        </select>
                    </div>
                    ...
                    <div class="col-md-6 mb-4 pb-2">
                        <div class="form-outline">
                            <div class="d-flex align-center">
                                ...
                                <input type="tel" id="phoneNumber" class="form-control number" placeholder="Phone Number" v-model="phoneNumber" required/>
                            </div>
                            <p class="text-danger" v-if="checkExist[1]">This phone number already exist.</p>
                        </div>
                    </div>
                </div>
...
import swal from 'sweetalert'
    export default{
        ...
        methods:{
            ...
            addStudent(){
                if(this.isRequired){
                    if(this.gender=="female"){
                        this.profile='../assets/female.png'
                    }else if(this.gender=="male"){
                        this.profile='../assets/male.png'
                    }else{
            ...
            checkRequired(){
                if(this.getAllData && !this.checkExist[0] && !this.checkExist[1] && this.email!="" && this.phoneNumber!=""){
